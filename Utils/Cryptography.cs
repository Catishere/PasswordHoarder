...
namespace PasswordHoarder.Utils
{
    public static class Cryptography
    {
        ...
        private static string _salt = "KIRfDqDDZRxtIRMz"; // Random
        private static string _vector = "40hYAcqMq8cuj9yy";// Random
        ...
        public static string EncodePassword(SecureString password)
        {
            using SHA256 sha256Hash = SHA256.Create();
            // ComputeHash - returns byte array  
            byte[] bytes = sha256Hash.ComputeHash(Encoding.UTF8.GetBytes(PasswordUtils.SecureStringToString(password)));
